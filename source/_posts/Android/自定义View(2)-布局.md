...
在 [自定义View(1)-测量](https://zjloong.github.io/2019/03/16/zi-ding-yi-view-ce-liang/)中已经讲过 **onMeasure**,  而**onLayout**的内容也不多. 因此下面结合二者, 通过几个实际案例说明它们的作用.
...
## 案例--流式布局(FlowLayout)
<img src="/images/layout_flow.jpg" width = "500"  />
...
## 案例-网格布局(GridLayout)
<img src="/images/layout_grid.jpg" width = "500"  />
*
### 自定义属性
```xml
<resources>
